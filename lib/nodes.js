(function() {
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.generateHook = function(o, code, node, justexpression) {
      if (justexpression == null) {
        justexpression = false;
      }
      return code = !node.isStatement(o) ? "(" + o.hook + "('beforeexpression', " + node.lineno + ")," + o.hook + "('expression', " + node.lineno + ", (" + code + ")))" : "" + o.hook + "('beforestatement', " + node.lineno + ");" + code;
    };
  ...
  exports.Block = Block = (function() {
    ...
    Block.prototype.compileNode = function(o) {
      ...
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        ...
        if (top) {
          node.front = true;
          code = node.compile(o);
          if (((o != null ? o.hook : void 0) != null) && !(1 === code.search(o.hook))) {
            code = this.generateHook(o, code, node);
          }
          codes.push(node.isStatement(o) ? code : this.tab + code + ';');
        } else {
          code = node.compile(o, LEVEL_LIST);
          if ((o != null ? o.hook : void 0) != null) {
            code = this.generateHook(o, code, node);
          }
          codes.push(code);
        }
    ...
    Block.prototype.compileWithDeclarations = function(o) {
      var assvars, code, decvars, exp, i, idx, post, rest, scope, _len, _ref2;
      code = post = '';
      _ref2 = this.expressions;
      ...
      if (scope.expressions === this) {
        if (o.scope.hasDeclarations()) {
          ...
          if (o.forceglobals != null) {
            for (i in o.forceglobals) {
              idx = decvars.indexOf(o.forceglobals[i]);
              if (idx !== -1) {
                decvars.splice(idx, 1);
              }
            }
          }
          if (decvars != null) {
            code += "" + this.tab + "var " + (decvars.join(', ')) + ";\n";
          }
        }
        if (scope.hasAssignments) {
          ...
          if (o.forceglobals != null) {
            for (i in o.forceglobals) {
              ...
              if (idx !== -1) {
                assvars.splice(idx, 1);
              }
            }
          }
          if (assvars != null) {
            code += "" + this.tab + "var " + (multident(assvars.join(', '), this.tab)) + ";\n";
          }
        }
      }
      return code + post;
  ...
  exports.Assign = Assign = (function() {
    ...
    Assign.prototype.compileNode = function(o) {
      ...
      if ((o.hook != null) && !this.context) {
        val = this.generateHook(o, val, this);
      }

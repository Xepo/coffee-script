(function() {
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.compile = function(o, lvl) {
      ...
      node.tab = o.indent;
      if (this.mycomment) {
        printLine("Got comment " + this.mycomment);
      }
      code = this.mycomment ? '/*' + multident(this.mycomment, this.tab) + '*/' : '';
      if (o.level === LEVEL_TOP || !node.isStatement(o)) {
        return code + node.compileNode(o);
      } else {
        return code + node.compileClosure(o);
      }
    };
  ...
  exports.Block = Block = (function() {
    ...
    Block.prototype.generateHook = function(o, code, bStatement) {
      return code = !bStatement ? "(" + o.hook + "('beforeexpression')," + o.hook + "('expression', (" + code + ")))" : "" + o.hook + "('beforestatement');" + code;
    };
      ...
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        ...
        if (top) {
          ...
          if ((o != null ? o.hook : void 0) != null) {
            code = this.generateHook(o, code, node.isStatement(o));
          }
  ...
  exports.surround = function(dollars, lineno, result) {
    var d, _i, _len, _ref2;
    if (!(result != null)) {
      return result;
    }
    result.lineno = lineno;
        if ((_ref2 = result.mycomment) != null) {
      _ref2;
    } else {
      result.mycomment = '';
    };
    ...
    for (_i = 0, _len = dollars.length; _i < _len; _i++) {
      d = dollars[_i];
      printLine("d:" + d + ":" + (d.comment != null));
      if (d.comment != null) {

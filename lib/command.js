(function() {
  ...
  compileOptions = function(filename) {
    ...
    return {
      ...
      bare: opts.bare,
      hook: opts.hook,
      forceglobals: (_ref2 = opts.forceglobals) != null ? _ref2.split(',') : void 0
    };
  };
  forkNode = function() {
    var args, nodeArgs;
